...
function setup() {
  ...
  sling1 = new Sling(bob1.body, { x: 500, y: 150 });
  sling2 = new Sling(bob2.body, { x: 550, y: 150 });
  sling3 = new Sling(bob3.body, { x: 600, y: 150 });
  sling4 = new Sling(bob4.body, { x: 650, y: 150 });
  sling5 = new Sling(bob5.body, { x: 700, y: 150 });
